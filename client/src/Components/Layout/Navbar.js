import logo from "../../Assets/watch1.png"
        ...
        <nav className='navbar navbar-expand-sm bg-primary navbar-dark fw-bold text-white'>
          <div className='container-fluid'>
            ...
            <ul className='navbar-nav'>
              ...
              <li className='nav-item'><a href='/customerorder' className='nav-link'> View Orders </a></li>
              <li className='nav-item'><a href='/todays' className='nav-link'> Todays Orders </a></li>
